    ...
    <div className="schedules-tbl-wrapper mt-3">
      <table>
        ...
        <tbody>
          ...
          {/* VAR */}
          <tr>
            <th style={thStyleTransformed} id="var" headers="vacc">
          ...
          {/* HPV */}
          <tr>
            <th style={thStyleTransformed} id="hpv" headers="vacc">
          ...
          {/* Pneumococcal */}
          <tr>
            <th style={thStyleTransformed} id="pneumo" headers="vacc">
...
export default ConditionSchedule;